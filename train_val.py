...
import rnn_model_walker
import dataset_walker
import utils_walker
import utils_ben_yuval
import params_setting_walker
...
def get_params(job, job_part):
    ...
    if job == 'medshapenet_20_50_12500':
        params = params_setting_walker.medshapeset_params()

    if job == 'medshapenet_20_50_12500_minimized_attacked':
        params = params_setting_walker.medshapeset_minimized_params_attacked()
